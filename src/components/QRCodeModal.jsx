                ...
                <div className="p-6 flex flex-col items-center">
                    ...
                    <div className="w-full bg-slate-50 rounded-lg p-3 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            <code className="text-xs text-light-blue-600 flex-1 break-all">{productUrl}</code>
                            <button
                                onClick={handleCopyUrl}
                                className="text-slate-500 hover:text-light-blue-600 p-1"
                                title="Copy URL"
                            >
                    ...
                    <button
                        ...
                        className="w-full bg-light-blue-600 hover:bg-light-blue-700 text-white px-4 py-3 rounded-lg flex items-center justify-center gap-2 transition-colors"
                    >
                        <Download size={18} />
                        Download QR Code
                    </button>
